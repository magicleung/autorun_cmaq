...
#> libraries using config.cmaq. Options: intel | gcc | pgi
 ...
 setenv compilerVrsn 17.0.5

#> Source the config_cmaq file to set the run environment
# pushd ../../../
# source ./config_cmaq.csh
 source ../CMAQ/CMAQ-5.2/config_cmaq.csh $compiler
# popd
...
#> Set General Parameters for Configuring the Simulation
 ...
 set APPL     = heatwave                   #> Application Name
...
#> Horizontal grid definition 
 setenv GRID_NAME heatwave               #> check GRIDDESC file for GRID_NAME options
 setenv GRIDDESC $CMAQ_DATA/mcip/${GridName}/GRIDDESC #> grid description file
 setenv IOAPI_ISPH 20                     #> GCTP spheroid, use 20 for WRF-based modeling

#> Vertical layer definition
 setenv LAYER_FILE $CMAQ_DATA/mcip/${Gridname}/METCRO3D_${GridName}.nc #>METCRO3D file from MCIP
